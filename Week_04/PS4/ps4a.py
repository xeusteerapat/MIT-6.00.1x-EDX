...
def getWordScore(word, n):
    ...
    temp_scores = []
    for i in word:
        temp_scores.append(SCRABBLE_LETTER_VALUES[i])
    if len(word) == n:
        points = (sum(temp_scores) * len(word)) + 50
    else:
        points = sum(temp_scores) * len(word)
    return points


#
# Problem #2: Make sure you understand how this function works and what
# it does!
#
